        ...
        <Slider initialSlide={true} slidesPerRow={4} dotsScroll={1} slidesToShow={1} >
          <VStack paddingRight={"2px"} paddingLeft={"2px"}  justifyContent={"center"}>
            <Image
              ...
              alt="image 1"
            />
            <Text casing={"uppercase"} fontSize="lg">SUGAR Air Kiss Powder Lipstick of your choice*</Text>
          </VStack>
          <VStack paddingRight={"2px"} paddingLeft={"2px"} justifyContent={"center"}>
            <Image
            width="100%"
            ...
            padding={"2px"}
              ...
              alt="image 2"
            />
            <Text casing={"uppercase"} fontSize="lg" px="4">SUGAR AIR KISS POWDER LIPSTICK OF YOUR CHOICE*</Text>
          </VStack>
          <VStack paddingRight={"2px"} paddingLeft={"2px"} justifyContent={"center"}>
            <Image
           width="100%"
           ...
           padding={"2px"}
              ...
              alt="image 3"
            />
            <Text casing={"uppercase"} fontSize="lg" px="4">Plum Tea Tree Dandruff Control Shampoo Mini</Text>
          </VStack>
          <VStack paddingRight={"2px"} paddingLeft={"2px"} justifyContent={"center"}>
            <Image
            width="100%"
            ...
            padding={"2px"}
              ...
              alt="image 4"
            />
            <Text casing={"uppercase"} fontSize="lg" px="4">Plum BodyLovin' Vanilla Vibes Body Oil Mini</Text>
          </VStack>
          <VStack paddingRight={"2px"} paddingLeft={"2px"} justifyContent={"center"} >
            <Image
            width="100%"
            ...
            padding={"2px"}
              ...
              alt="image 5"
            />
            <Text casing={"uppercase"} fontSize="lg" px="4">Bonus*</Text>
          </VStack>
        </Slider>
