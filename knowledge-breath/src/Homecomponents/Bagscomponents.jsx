...
export default function Bagscomponents() {
  return (
    <Stack align="center" className="Stack-slider">
      ...
      <Stack justifyContent={"flex-start"} className="" width="95%" justifySelf={"flex-start"}>
        <Slider initialSlide={true} slidesPerRow={4} dotsScroll={1} slidesToShow={1} >
          <VStack border="3px solid #e5b95f" width={"80%"}>
            <Image
              width="100%"
              borderRadius="3xl"
              ...
              alt="image 1"
            />
            <Text fontSize="lg">SUGAR Air Kiss Powder Lipstick of your choice*</Text>
          </VStack>
          <VStack border="3px solid #e5b95f" justifyContent={"center"}>
            <Image
            width="100%"
              borderRadius="3xl"
              ...
              alt="image 2"
            />
            <Text fontSize="lg" px="4">SUGAR AIR KISS POWDER LIPSTICK OF YOUR CHOICE*</Text>
          </VStack>
          <VStack border="3px solid #e5b95f" justifyContent={"center"}>
            <Image
            width="100%"
              ...
              alt="image 3"
            />
            <Text fontSize="lg" px="4">Plum Tea Tree Dandruff Control Shampoo Mini</Text>
          </VStack>
          <VStack border="3px solid #e5b95f" justifyContent={"center"}>
            <Image
            width="100%"
              ...
              alt="image 4"
            />
            <Text fontSize="lg" px="4">Plum BodyLovin' Vanilla Vibes Body Oil Mini</Text>
          </VStack>
          <VStack border="3px solid #e5b95f" justifyContent={"center"} >
            <Image
            width="100%"
              ...
              alt="image 5"
            />
            <Text fontSize="lg" px="4">Bonus*</Text>
          </VStack>
        </Slider>
